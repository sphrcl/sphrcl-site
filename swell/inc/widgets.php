...
class TTrust_Recent_Posts extends WP_Widget {
	...
	function TTrust_Recent_Posts() {
		...
		$this->WP_Widget('ttrust_recent_posts', $ttrust_theme_name.' '.__('Recent Posts', 'swell'), $widget_ops);
	}
...
class TTrust_Flickr extends WP_Widget {
	...
	function TTrust_Flickr() {
		...
		$this->WP_Widget('ttrust_flickr', $ttrust_theme_name.' '.__('Flickr', 'swell'), $widget_ops);
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'swell'); ?>
			<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
			</label>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('user'); ?>"><?php _e('Flickr ID:', 'swell'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('flickr_nr'); ?>"><?php _e('Number of photos:', 'swell'); ?></label>
